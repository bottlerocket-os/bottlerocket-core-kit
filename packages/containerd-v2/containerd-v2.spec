...
%global gover 2.0.2
%global rpmver %{gover}
%global gitrev c507a0257ea6462fbd6f5ba4f5c74facb04021f4
...
Release: 1%{?dist}
Epoch: 0
Summary: An industry-standard container runtime (v2)
License: Apache-2.0
URL: https://%{goimport}
Source0: https://%{goimport}/archive/v%{gover}/%{gorepo}-%{gover}.tar.gz
Source1: containerd-v2.service
...
%{_cross_unitdir}/containerd-v2.service
