...
# Ephemeral encryption keys combines encrypt+unlock in one unit
...
install -p -m 0644 %{S:1661} %{buildroot}%{_cross_unitdir}/prepare-local-fs.service.d/20-ephemeral.conf
