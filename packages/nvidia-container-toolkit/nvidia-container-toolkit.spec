...
# The CDI spec generation unit. Its default ExecStart creates no
# backwards-compat symlinks.
Source7: generate-cdi-specs.service
# Drop-in template that variants can render to override ExecStart, adding the
# legacy /usr/lib/nvidia/tesla symlinks.
