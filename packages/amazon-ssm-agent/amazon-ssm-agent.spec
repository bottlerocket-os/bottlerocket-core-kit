...
Source3: amazon-ssm-agent-tmpfiles.conf
...
install -d %{buildroot}{%{_cross_bindir},%{_cross_fips_bindir}}/amazon-ssm-agent
for b in amazon-ssm-agent ssm-agent-worker ssm-session-worker; do
  install -p -m 0755 ${b} %{buildroot}%{_cross_bindir}/amazon-ssm-agent
  install -p -m 0755 fips/${b} %{buildroot}%{_cross_fips_bindir}/amazon-ssm-agent
done
...
%{_cross_tmpfilesdir}/amazon-ssm-agent-tmpfiles.conf
%dir %{_cross_factorydir}%{_cross_sysconfdir}/amazon/ssm
%{_cross_factorydir}%{_cross_sysconfdir}/amazon/ssm/amazon-ssm-agent.json

%files bin
%dir %{_cross_bindir}/amazon-ssm-agent
%{_cross_bindir}/amazon-ssm-agent/amazon-ssm-agent
%{_cross_bindir}/amazon-ssm-agent/ssm-agent-worker
%{_cross_bindir}/amazon-ssm-agent/ssm-session-worker

%files fips-bin
%dir %{_cross_fips_bindir}/amazon-ssm-agent
%{_cross_fips_bindir}/amazon-ssm-agent/amazon-ssm-agent
%{_cross_fips_bindir}/amazon-ssm-agent/ssm-agent-worker
%{_cross_fips_bindir}/amazon-ssm-agent/ssm-session-worker
